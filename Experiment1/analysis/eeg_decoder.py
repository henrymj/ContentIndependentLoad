...
class Wrangler:
    ...
    def bin_and_split_data(self, xdata, ydata, test_size=0.20, train_labels=None, downsamp_test=False):
        """
        ...
        for self.ifold in range(self.n_splits):
            ...
            if train_labels is not None:
                ...
                if downsamp_test:
                    # downsample the test data to match the number of trials from the trainind conditions that are also tested
                    _, X_test_opts, _, y_test_opts = train_test_split(
                        X_test_opts, y_test_opts, stratify=y_test_opts, test_size=test_size
                    )
