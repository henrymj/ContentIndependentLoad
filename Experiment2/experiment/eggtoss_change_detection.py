...
number_of_trials_per_block = 44  # 52
...
#            reject = False
    ...
    def run(self):
        ...
        for block_num in range(self.number_of_blocks+2):
...
#                block_feature = self.experiment_info['Run'] % 2
                block = self.make_block(
                    block_num=block_num, number_of_trials_per_block=20, num_ss0_trials=10)
            self.rej_counter = []
            acc = []
