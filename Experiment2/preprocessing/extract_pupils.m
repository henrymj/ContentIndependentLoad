...
subjectDirectories={'01/1','01/2','01/3','01/4','01/5','02/1','02/2','02/3','02/4','02/5','03/1','03/2','03/3','03/4','03/5','04/1','04/2','04/3','04/4','04/5','05/1','05/2','05/3','05/4','05/5','06/1','06/2','06/3','06/4','06/5','07/1','07/2','07/3','07/4','07/5','08/1','08/2','08/3','08/4','08/5','10/1','10/2','10/3','10/4','10/5','11/1','11/2','11/3','11/4','11/5','13/1','13/2','13/3','13/4','13/5','14/1','14/2','14/3','14/4','15/1','15/2','15/3','15/4','15/5','16/1','16/2','16/3','16/4','16/5','18/1','18/2','18/3','18/4','18/5','19/1','19/2','19/3','19/4','19/5'};
...
%         fprintf(log, ['Skipping ', subdirPath, '. More than one asc file found.\n\n']);
    ...
    if strcmp(eyeRecorded, 'both')
        EEG = pop_importeyetracker(EEG, EYEEEGMatFilename, [startEvent endEvent], [2 3 4 5 6 7], {'L_GAZE_X' 'L_GAZE_Y', 'L_PUPIL', 'R_GAZE_X' 'R_GAZE_Y', 'R_PUPIL'}, 0, 1, 0, 0);
    else
        EEG = pop_importeyetracker(EEG, EYEEEGMatFilename, [startEvent endEvent], [2 3 4], {'GAZE_X' 'GAZE_Y', 'PUPIL'}, 0, 1, 0, 0);
    end
    diary off
    ...
    EEG = pop_epochbin(EEG, [trialStart, trialEnd], 'none');
    ...
    pupildata_filename = strjoin({subdirPath, '/pupildata.mat'},'');
    pupildata = create_pupildata(EEG, all_chans);
    save(pupildata_filename, 'pupildata');
...
function pupildata = create_pupildata(EEG, all_chans)
    % create xdata for saving to .mat
    chan_idx = ismember(all_chans,{'L-PUPIL','R-PUPIL','PUPIL'});

    pupildata = EEG.data(chan_idx,:,:);
end